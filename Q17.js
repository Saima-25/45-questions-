...
console.log("Unfortunately, the new dinner table won't arrive in time for the dinner, and we can only invite two people."); // // Inform that only two people can be invited for dinner
